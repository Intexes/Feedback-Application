...
Feedbacket — это полноценная система для сбора, анализа отзывов о отелях с различных платформ TripAdvisor, Google Maps, Яндекс.Карты) и автоматической генерации ответов с использованием российских языковых моделей ruBERT и ruGPT-3.
